...
public abstract class Request {
	...
	protected Player receiver = null; //Empf§nger der Anfrage
	protected RequestType type = RequestType.UNDEFINED; //Was f§r eine Anfrage ist das?
	...
	public void tick() {
		if(timeLeft == 0) {
			isExpired = true;
			sender.sendMessage("");
			sender.sendMessage(Prefixes.REQUEST.getPrefix()+"Deine Anfrage an §e"+receiver.getName()+" §bist abgelaufen");
			sender.sendMessage("");
			receiver.sendMessage("");
			receiver.sendMessage(Prefixes.REQUEST.getPrefix()+"Deine Anfrage von §e"+sender.getName()+" §bist abgelaufen");
			receiver.sendMessage("");
	...
	public static class RequestManager extends BukkitRunnable {
		...
		/*
		 * TODO: F§hrt den Manager herunter(L§scht alle Anfragen und stoppt den Timer)
		 */
		...
		/*
		 * TODO: Gibt die erhaltene Anfrage zur§ck
		 */
		...
		/*
		 * TODO: Gibt zur§ck, ob ein Spieler eine Anfrage gesendet hat
		 */
		...
		/*
		 * TODO: Gibt zur§ck, ob ein Spieler eine Anfrage erhalten hat
		 */
		...
		/*
		 * TODO: F§gt eine Anfrage zur Warteschlange hinzu
		 */
		...
		/*
		 * TODO: L§scht eine Anfrage aus der Warteschlange
		 */
