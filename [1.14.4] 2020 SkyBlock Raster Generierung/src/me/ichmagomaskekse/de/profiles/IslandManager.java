...
public class IslandManager {
	...
	/*
	 * TODO: Gibt zur§ck, ob ein Spieler sich auf einem Insel Grundst§ck befindet
	 */
	public static boolean isInIslandRegion(String uuid_target, Player p) {
		for(Player t : profiles.keySet()) {
			//TODO: Zu m§de um diese Methode zu programmieren
		}
		return false;
	}
	
	/*
	 * TODO: Gibt das Insel Profil zur§ck
	 */
	...
	public static class IslandProfile {
		...
		/*
		 * TODO: Gibt die ID von der Insel zur§ck
		 */
		...
		/*
		 * TODO: Gibt die UUID des Owners zur§ck
		 */
		...
		/*
		 * TODO: Gibt zur§ck, ob der Spieler p sich auf dem Grundst§ck der Insel befindet
		 */
