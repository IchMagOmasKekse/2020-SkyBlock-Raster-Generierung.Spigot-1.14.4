...
import me.ichmagomaskekse.de.commands.SkyBlockCommandFunction;
...
public class VisitRequest extends Request {
	...
	public VisitRequest(Player sender, Player receiver) {
		...
		sender.sendMessage(Prefixes.REQUEST.getPrefix()+"Deine Anfrage wurde verschickt. Diese gilt f§r §75 Minuten");
		receiver.sendMessage(Prefixes.REQUEST.getPrefix()+"§e"+sender.getName()+" §bm§chte deine Insel besuchen");
