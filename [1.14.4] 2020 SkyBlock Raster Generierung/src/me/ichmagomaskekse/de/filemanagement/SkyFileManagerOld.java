...
public class SkyFileManagerOld {
	...
	/*
	 * Diese Klasse ist keine optimale L철sung.
	 * Beim Abfragen gewissen Daten verursacht diese Klasse Laggs,
	 * da es nur eine Datei gibt, wo alle drinnen steht und diese vo Speicher her zu gro횩 ist.
	 */
	...
	public SkyFileManagerOld() {
		if(file.exists() == false) {
			SkyBlock.sendOperatorMessage("Die Island-Databank.yml im Ordner 쬯'�7/plugins/SkyBlock/쬯'쬬 existiert nicht!",
					                     "Gebe 쬷bitte쬬 umgehend �7쬷IchMagOmasKekse쬬 Bescheid!");
		}
	}
	
	
	/*
	 * TODO: Gibt eine ArrayList mit allen Banned Players zur체ck
	 */
	...
	/*
	 * TODO: Gibt eine ArrayList mit allen Members zur체ck
	 */
	...
	/*
	 * TODO: Gibt eine HashMap mit allen Settings zur체ck
	 */
	...
	/*
	 * TODO: Gibt die ID der Insel B zur체ck, mit der sich die Insel A verbunden hat
	 */
	...
	/*
	 * TODO: Gibt die Z-Koordinate zur체ck, auf der sich die Insel befindet
	 */
	...
	/*
	 * TODO: Gibt die X-Koordinate zur체ck, auf der sich die Insel befindet
	 */
	...
	/*
	 * TODO: Gibt die Welt zur체ck, in der sich die Insel befindet
	 */
	...
	/*
	 * TODO: Gibt die UUID des Insel-Besitzers zur체ck
	 */
	...
	/*
	 * TODO: Gibt einen Boolean zur체ck, ob die Insel belegt oder frei ist
	 */
	...
	/*
	 * TODO: Gibt die Anzahl an freien Inseln zur체ck
	 */
	...
	/*
	 * TODO: Gibt die Anzahl an Belegten Inseln zur체ck
	 */
	...
	/*
	 * TODO: Gibt die Anzahl an Generierten Inseln zur체ck
	 */
